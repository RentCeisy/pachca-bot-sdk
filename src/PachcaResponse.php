...
use Rentceisy\PachcaBotSdk\Exceptions\PachcaResponseException;
use Rentceisy\PachcaBotSdk\Exceptions\PachcaSDKException;
use Psr\Http\Message\ResponseInterface;

/**
 * Class PachcaResponse.
 *
 * Handles the response from Pachca API.
 */
final class PachcaResponse
{
    ...
    /** @var PachcaSDKException The exception thrown by this request. */
    private PachcaSDKException $thrownException;
     ...
     */
    public function __construct(/** @var PachcaRequest The original request that returned this response. */
        private PachcaRequest $request,
        $response
    ) {
    ...
    {
        $this->thrownException = PachcaResponseException::create($this);
    }

    /**
     * Return the original request that returned this response.
     */
    public function getRequest(): PachcaRequest
    {
        return $this->request;
    }
     ...
     *
     * @return PachcaSDKException
     *
     * @throws PachcaSDKException
     */
    public function throwException(): PachcaSDKException
    {
