 ...
 * Class PachcaRequest.
 *
 * Builds Pachca Bot API Request Entity.
 */
final class PachcaRequest
{
    ...
    public function validateAccessToken(): void
    {
        if ($this->accessToken === null) {
            throw new PachcaSDKException('You must provide your bot access token to make any API requests.');
        }
    }
